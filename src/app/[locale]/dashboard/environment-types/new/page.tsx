...
import { createEnvironmentType, type ActionState } from "@/actions/environment-types";

export default function NewEnvironmentTypePage() {
  const [state, action, pending] = useActionState<ActionState, FormData>(createEnvironmentType, {});
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-text">Novo Tipo de Ambiente</h1>
          <p className="mt-1 text-sm text-text-subtle">Adicione um novo tipo de ambiente ao sistema.</p>
        </div>
      </div>
        ...
        <form action={action} className="space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              name="description"
              rows={3}
              placeholder="Descrição opcional do tipo de ambiente..."
